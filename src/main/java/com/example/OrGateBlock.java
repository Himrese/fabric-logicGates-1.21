...
public class OrGateBlock extends AbstractRedstoneGateBlock {
    public static final MapCodec<OrGateBlock> CODEC = createCodec(OrGateBlock::new);
    ...
    public static final Block AND_BLOCK = register("or", new OrGateBlock(Block.Settings.create().strength(1.0f)));
    ...
    // 构造函数
    public OrGateBlock(AbstractBlock.Settings settings) {
        super(settings);
