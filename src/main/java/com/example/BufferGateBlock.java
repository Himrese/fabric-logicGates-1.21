...
public class BufferGateBlock extends AbstractRedstoneGateBlock {
    public static final MapCodec<BufferGateBlock> CODEC = createCodec(BufferGateBlock::new);
    ...
    public static final Block AND_BLOCK = register("buffer", new BufferGateBlock(Block.Settings.create().strength(1.0f)));
    ...
    // 构造函数
    public BufferGateBlock(AbstractBlock.Settings settings) {
        super(settings);
