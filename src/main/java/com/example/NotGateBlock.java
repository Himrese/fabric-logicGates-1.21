...
public class NotGateBlock extends AbstractRedstoneGateBlock {
    public static final MapCodec<NotGateBlock> CODEC = createCodec(NotGateBlock::new);
    ...
    public static final Block AND_BLOCK = register("not", new NotGateBlock(Block.Settings.create().strength(1.0f)));
    ...
    // 构造函数
    public NotGateBlock(AbstractBlock.Settings settings) {
        super(settings);
