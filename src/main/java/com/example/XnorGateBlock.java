...
public class XnorGateBlock extends AbstractRedstoneGateBlock {
    public static final MapCodec<XnorGateBlock> CODEC = createCodec(XnorGateBlock::new);
    ...
    public static final Block AND_BLOCK = register("xnor", new XnorGateBlock(Block.Settings.create().strength(1.0f)));
    ...
    // 构造函数
    public XnorGateBlock(AbstractBlock.Settings settings) {
        super(settings);
