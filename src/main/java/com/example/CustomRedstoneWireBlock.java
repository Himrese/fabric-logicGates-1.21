...
public class CustomRedstoneWireBlock extends Block {
	public static final MapCodec<CustomRedstoneWireBlock> CODEC = createCodec(CustomRedstoneWireBlock::new);
	...
	@Override
	public MapCodec<CustomRedstoneWireBlock> getCodec() {
		return CODEC;
	}

	public CustomRedstoneWireBlock(AbstractBlock.Settings settings) {
		super(settings);
