...
public class NorGateBlock extends AbstractRedstoneGateBlock {
    public static final MapCodec<NorGateBlock> CODEC = createCodec(NorGateBlock::new);
    ...
    public static final Block AND_BLOCK = register("nor", new NorGateBlock(Block.Settings.create().strength(1.0f)));
    ...
    // 构造函数
    public NorGateBlock(AbstractBlock.Settings settings) {
        super(settings);
